...
# This allows sensitive values to be set via .env file instead of hardcoding in config
if 'WRITEHAT_ADMIN_PASSWORD' in os.environ:
    writehat_config['writehat']['admin_password'] = os.environ['WRITEHAT_ADMIN_PASSWORD']
if 'WRITEHAT_SECRET_KEY' in os.environ:
    writehat_config['writehat']['secret'] = os.environ['WRITEHAT_SECRET_KEY']
if 'WRITEHAT_ADMIN_USERNAME' in os.environ:
    writehat_config['writehat']['admin_username'] = os.environ['WRITEHAT_ADMIN_USERNAME']
